 ...
 */
class DorisSqlLocalPool extends SqlLocalPoolHandler{
    DorisSqlLocalPool(DatasourceProperties datasourceProperties, Map<String, Object> otherPoolConfig = [:]) {
