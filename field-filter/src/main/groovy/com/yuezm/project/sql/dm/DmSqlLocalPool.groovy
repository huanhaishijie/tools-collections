 ...
 * @version 1.0
 * @description ${TODO}
 * @date 2026/1/15 10:04
 */
class DmSqlLocalPool extends SqlLocalPoolHandler{
    DmSqlLocalPool(DatasourceProperties datasourceProperties, Map<String, Object> otherPoolConfig = [:]) {
